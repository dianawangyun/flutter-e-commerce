...
class TAppTheme {
  TAppTheme._(); // private sign, avoid creating instances
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    inputDecorationTheme: TTextFormFieldTheme.lightInputDevorationTheme,
  );
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    inputDecorationTheme: TTextFormFieldTheme.darkInputDevorationTheme,
  );
}
